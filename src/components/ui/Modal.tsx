...
export function Modal({
    ...
    return (
        <div
            ...
            <div className='rounded-2 font-bold flex flex-col bg-ve-light overflow-hidden min-w-[300px]  max-w-[80%] max-h-[80%]'>
                <ModalHeader
                    title={title}
...
function ModalClose({ onClick }: { onClick: () => void }) {
    return (
        <button
            onClick={onClick}
            className='flex items-center justify-center w-8 h-8 color-ve-dark hover:bg-ve-dark/10 ml-auto'>
